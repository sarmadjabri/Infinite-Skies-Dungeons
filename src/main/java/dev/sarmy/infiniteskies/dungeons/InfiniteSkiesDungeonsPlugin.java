...
import dev.sarmy.infiniteskies.dungeons.mob.behavior.DustWretchBehavior;
...
public final class InfiniteSkiesDungeonsPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        mobManager.register(new DustWretchBehavior());
        ...
        mobManager.register(new ObservatoryWatcherBehavior(projectileService));
        mobManager.register(new VenomSpitterBehavior(projectileService));
        mobManager.register(new GaleAcolyteBehavior(projectileService));
        mobManager.register(new MossPriestBehavior());
        mobManager.register(new VoidMenderBehavior(projectileService));
        ...
        mobManager.register(new FrostWispBehavior(projectileService));
